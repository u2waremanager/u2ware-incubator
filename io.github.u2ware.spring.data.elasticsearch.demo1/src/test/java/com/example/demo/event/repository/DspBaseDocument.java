...
@Document(indexName = "#{dspBaseDocumentIndex.indexName}", type="#{dspBaseDocumentIndex.type}")
public @Data class DspBaseDocument {

	public static final String aggAsset = "aggAsset";
	public static final String aggAnom = "aggAnom";
	public static final String aggUniq = "aggUniq";
	public static final String aggStats = "aggStats";
	
	
	public final static Integer EVENT_TYPE = 0;	// base-normal
	...
	public String getFormattedEventStartTime() {
		return (eventStartTime == null ? "" : new DateTime(eventStartTime).toString("yyyyMMdd"));
	}
	
	@Override
	public String toString() {
		return "DspBase [id=" + id + ", eventType=" + eventType+", tenantId " + tenantId + ", domainId " + domainId  +", eventStartTime=" + eventStartTime + "/"+getFormattedEventStartTime()+"]";
	}
