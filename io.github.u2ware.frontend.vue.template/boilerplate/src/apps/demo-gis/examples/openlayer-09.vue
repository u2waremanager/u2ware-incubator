<template>
   <div stype="width: 640px; height: 480px">
    <div id="kakaomap" style="position: absolute; left:0px; top:30px; z-index: 1; width: 640px; height: 480px; margin: 0;  padding:0;"></div>
    <div id="map" style="position: absolute; left:0px; top:30px; z-index: 1; width: 640px; height: 480px; margin: 0;  padding:0;"></div>
  </div>
