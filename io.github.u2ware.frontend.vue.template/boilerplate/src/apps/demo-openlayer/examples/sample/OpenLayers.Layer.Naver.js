...
OpenLayers.Layer.Naver = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    name: "NaverMap",
    url: [
		"http://onetile1.map.naver.net/get/7/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
		"http://onetile2.map.naver.net/get/7/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
		"http://onetile3.map.naver.net/get/7/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
		"http://onetile4.map.naver.net/get/7/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an"
    ],
