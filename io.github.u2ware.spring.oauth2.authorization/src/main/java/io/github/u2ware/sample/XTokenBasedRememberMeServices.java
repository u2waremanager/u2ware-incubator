...
//@Component
public class XTokenBasedRememberMeServices extends TokenBasedRememberMeServices{

	
	protected Log logger = LogFactory.getLog(getClass());

	
	public XTokenBasedRememberMeServices(String key, UserDetailsService userDetailsService) {
	...
	protected UserDetails processAutoLoginCookie(String[] cookieTokens,
		...
		logger.info("processAutoLoginCookie: "+request.getRequestURI());
